...
```
Service frontend -> accounts.codevertexafrica.com/login
...
|---------|-----------|-------------|
| Auth UI | `auth-ui` | `https://accounts.codevertexafrica.com/auth/callback` |
| Ordering App | `ordering-app` | `https://ordering.codevertexafrica.com/callback` |
| POS | `pos-app` | `https://pos.codevertexafrica.com/callback` |
| Notifications UI | `notifications-ui` | `https://notifications.codevertexafrica.com/[orgSlug]/auth/callback` |
| Subscriptions UI | `subscriptions-ui` | `https://pricing.codevertexafrica.com/auth/callback` |
...
|----------|-------------|---------|
| `NEXT_PUBLIC_API_URL` | Auth API base URL | `https://sso.codevertexafrica.com/api/v1` |
| `NEXT_PUBLIC_AUTH_URL` | Auth API root | `https://sso.codevertexafrica.com` |
| `NEXT_PUBLIC_CLIENT_ID` | OAuth client ID for auth-ui | `auth-ui` |
| `NEXT_PUBLIC_REDIRECT_URI` | OIDC callback URL | `https://accounts.codevertexafrica.com/auth/callback` |
...
Auth-ui at `accounts.codevertexafrica.com` communicates with auth-api at `sso.codevertexafrica.com`. CORS must allow:

- Origin: `https://accounts.codevertexafrica.com`
