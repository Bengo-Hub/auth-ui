...
/**
 * Email + verification status. Shown to EVERY SSO user (each manages their own address).
 * Accounts provisioned without a real email see a prompt to add one — verifying the code
 * sent to the new address replaces the placeholder on the account, and auth-api propagates
 * the change to every service via auth.user.updated.
 */
      ...
      <div className="lg:col-span-2">
        <FieldCard>
          <form onSubmit={handleSave} className="space-y-6">
            ...
            {/* Email + verification. Every SSO user manages their own address here; an
